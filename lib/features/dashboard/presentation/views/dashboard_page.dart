...
class _DashboardPageState extends ConsumerState<DashboardPage>
  ...
  Future<void> _pickPeriodAnchor(
    ...
    if (pickedDate != null) {
      ref.read(dashboardAnchorDateStateProvider.notifier).setAnchorDate(pickedDate);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final selectedPeriod = ref.watch(dashboardPeriodStateProvider);
    final selectedDate = ref.watch(dashboardAnchorDateStateProvider);
    final categories = ref.watch(categoryViewModelProvider).value ?? [];
        ...
        children: [
          ...
          _DashboardSummaryCard(
            ...
            onPeriodChanged: (period) {
              ref.read(dashboardPeriodStateProvider.notifier).setPeriod(period);
            },
            onPickPeriod: () {
